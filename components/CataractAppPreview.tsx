...
const CataractAppPreview: React.FC = () => {
  return (
    <div className="w-full max-w-[340px] mx-auto bg-brand-text rounded-[3.2rem] p-3 shadow-[0_25px_60px_-15px_rgba(0,0,0,0.3)] border-[9px] border-brand-text relative overflow-hidden aspect-[9/19] flex flex-col justify-between select-none">
      
      {/* Top Speaker / Camera Notch */}
      <div className="absolute top-0 left-1/2 transform -translate-x-1/2 w-28 h-5 bg-brand-text rounded-b-2xl z-40 flex items-center justify-center">
      ...
      <div className="relative w-full h-full rounded-[2.5rem] overflow-hidden bg-neutral-950 flex flex-col justify-between p-4 pt-8">
        ...
        <div className="relative flex-grow rounded-2xl border border-neutral-800 bg-[#0e0d0c] overflow-hidden flex items-center justify-center">
          ...
          <svg
            viewBox="0 0 200 200"
            className="w-full h-full max-w-[170px] text-brand-accent/30"
            fill="none"
            stroke="currentColor"
            strokeWidth="1.2"
          >
            <defs>
              <linearGradient id="laserGrad" x1="0" y1="0" x2="0" y2="1">
                <stop offset="0%" stopColor="#b58b2a" stopOpacity="0" />
                <stop offset="50%" stopColor="#b58b2a" stopOpacity="0.5" />
                <stop offset="100%" stopColor="#b58b2a" stopOpacity="0" />
              </linearGradient>
            </defs>

            {/* Viewport Reticle Brackets */}
            <path d="M15,35 L15,15 L35,15" stroke="#b58b2a" strokeWidth="2.2" strokeLinecap="round" />
            <path d="M185,35 L185,15 L165,15" stroke="#b58b2a" strokeWidth="2.2" strokeLinecap="round" />
            <path d="M15,165 L15,185 L35,185" stroke="#b58b2a" strokeWidth="2.2" strokeLinecap="round" />
            <path d="M185,165 L185,185 L165,185" stroke="#b58b2a" strokeWidth="2.2" strokeLinecap="round" />

            {/* Stylized Eye Outlines */}
            <path
              d="M30,100 C50,55 150,55 170,100 C150,145 50,145 30,100 Z"
              stroke="#b58b2a"
              strokeWidth="2"
              opacity="0.45"
            />
            {/* Iris */}
            <circle cx="100" cy="100" r="34" stroke="#b58b2a" strokeWidth="1.5" opacity="0.65" />
            {/* Pupil */}
            <circle cx="100" cy="100" r="16" fill="#1c1c1c" stroke="#b58b2a" strokeWidth="1.2" />

            {/* Feature Landmarks */}
            <g fill="#b58b2a" opacity="0.8">
            ...
            {/* Scanning Laser Line */}
            <g>
              <line x1="20" y1="100" x2="180" y2="100" stroke="#b58b2a" strokeWidth="2.5" opacity="0.85">
                <animate
                  attributeName="y1"
                  values="40;160;40"
                  dur="4.5s"
        ...
        <div className="mt-4 bg-neutral-900 border border-neutral-800 rounded-2xl p-4 flex flex-col gap-3.5 z-10 shadow-lg">
          <div className="flex justify-between items-start">
            <div>
              <div className="text-[9px] uppercase tracking-wider font-semibold text-brand-accent mb-0.5">
                Ocular Report
              </div>
              <h4 className="text-sm font-bold text-white font-serif">Anterior Assessment</h4>
            </div>
            <div className="bg-brand-accent/15 border border-brand-accent/20 text-brand-accent px-2 py-0.5 rounded-full text-[9px] font-semibold">
              98.4% CONF
            </div>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2 text-[9px] font-mono border-t border-b border-neutral-800 py-2.5">
            ...
            <div className="text-neutral-400">
              ...
              <span className="text-brand-accent">Nuclear Cataract</span>
            </div>
          </div>
          ...
          <div className="flex items-center justify-between text-[10px] text-white">
            ...
            <div className="flex items-center gap-1 font-semibold text-brand-accent cursor-pointer">
