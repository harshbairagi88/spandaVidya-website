...
const MissionCard: React.FC<MissionCardProps> = ({ title, text }) => {
  return (
    <Card className="flex flex-col text-left  ">
      <h3 className="font-serif text-2xl font-bold mb-2 flex items-center gap-2" style={{ color: T.accent }}>
...
const Mission: React.FC = () => {
  return (
    <section id="mission" className="py-0 px-2 md:px-[8vw]  text-center">
      {/* <div className="max-w-4xl mx-auto bg-red-500">
        <div 
          className="inline-block px-4 py-0 rounded-full text-xs font-semibold mb-8 tracking-widest uppercase border"
          style={{ 
